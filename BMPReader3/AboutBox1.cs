...
namespace BPview.Resources
{
	partial class AboutBox1 : Form
	{
        ...
        public String comment =
                        "v.3.13.106" + "\r\n" +
                        " - Немного увеличилось быстродействие. ХЗ почему :)" + "\r\n" +
                        " - Добавлена эквализация по гистограмме." + "\r\n" +
                        " - Добавлена резкость (Sharpen)." + "\r\n" +
                        "v.3.12.100" + "\r\n" +
                        " - Добавлена возможность запуска файлов из командной строки." + "\r\n" +
                        "v.3.12.99" + "\r\n" +
						" - По просьбе тов. Суровцева добавлено замедление воспроизведения (до 1 сек между кадрами)." + "\r\n" +
						"v.3.12.97" + "\r\n" +
